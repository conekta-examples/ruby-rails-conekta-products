HelloConektaRubyRails::Application.routes.draw do
  resources :events
  post 'process_event' => 'events#process_event'
  ...
  root 'welcome#index'
  post 'process_payment' => 'welcome#process_payment'
  post 'order' => 'welcome#order'
